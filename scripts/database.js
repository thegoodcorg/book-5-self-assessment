...
export const getPurchases = () => {return database.purchases.map(purchase => ({...purchase}))}

export const getVeggies = () =>{return database.veggies.map(vegetable => ({...vegetable}))}

export const getEntrees = () =>{return database.entrees.map(entree => ({...entree}))}

export const getSides = () =>{return database.sides.map(side => ({...side}))}

export const addPurchase = () => {
    const newOrder = {...database.comboChoices}

    const lastIndex = database.purchases.length
